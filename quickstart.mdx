...
<Tabs>
  <Tab title="JavaScript">
    ...
    if (result.recommendation === 'block') {
      ...
      console.log('Email flagged for review:', result.signals);
    } else {
...
```typescript
{
  ...
  "recommendation": "allow", // "allow", "flag", or "block"
  "signals": {
    "syntax": { "valid": true, "action": "allow" },
    "disposable": { "valid": true, "action": "allow" },
    "mx": { "valid": true, "action": "allow" },
    "smtp": { "valid": true, "action": "allow" },
    "catchall": { "valid": false, "action": "flag" },
    "roleEmail": { "valid": false, "action": "allow" },
    "alias": { "valid": false, "action": "flag" },
    "deviceFingerprint": { "valid": true, "action": "allow" },
    "ipReputation": { "valid": true, "action": "allow" }
  },
  "metadata": {
    "deviceId": "abc123...",
